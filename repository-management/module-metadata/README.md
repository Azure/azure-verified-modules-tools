...
The shared `Get-AvmModuleMetadata`, `Initialize-AvmModuleMetadata`, and
`Test-AvmModuleMetadata` commands support local Bicep file creation. The archived
owner-team reader retains every member and maintainer handle; it does not copy
personal names or invent replacement owners.
