...
| 4     | Replace `grept`; audit `mapotf` + `avmfix` | Medium               | `grept` policies all dispositioned in `quality-standards.md` § Appendix A (5 ported via 4 primitives, 2 dropped); `mapotf` + `avmfix` audit deliverables landed in `quality-standards.md` |
