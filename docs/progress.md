...
**Last updated**: 2026-05-21 (Phase 1: Bicep docs walker — Resource Types section landed)
...
| 1     | Bicep facade                | **Walker advancing** — `format`/`lint`/`test` engines wired; `docs` ARM-JSON walker now emits the Resource Types and Outputs sections (Parameters / Usage / Cross-refs still TODO); heavier verbs (`avm new`, `avm transform`, policy, convention) not started |
