...
Use `modules/<module-path>/avm.tflint.override.hcl` or
`examples/<example-path>/avm.tflint.override.hcl` to override one scope. For
...
staged configs, preventing traversal and sibling collisions.
